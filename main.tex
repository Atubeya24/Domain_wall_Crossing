...
\begin{answerbox}
    ...
    \begin{gather*}
        ...
        h_{int}=i\Gamma^{0}\Gamma^{2}\partial_{2}+i\Gamma^{0}\Gamma^{7}[X_{7},\cdot]
    \end{gather*}
    ...
    \begin{proofbox}
        ...
        故に2も成立。
    \end{proofbox}
    次に、演算子[]の、非自明な同時固有ベクトルを考える。ただし、1点注意しなければならないのが、spinorもAdjoint-matterであることである。
    ...
    \begin{resultbox}{$\Gamma^{3}\Gamma^{4}[X_{4},\cdot],\Gamma^{2}\Gamma^{7}[Y_{7},\cdot]$の同時固有ベクトル}
        ...
        \begin{align*}
            ...
            \pm_{1}\Gamma^{34}\Psi_{\pm_{1}} \otimes B
        \end{align*}
    ...
    \begin{proofbox}
        ...
        \begin{resultbox}{$\Gamma^{3}\Gamma^{4}[X_{4},\cdot]$の固有ベクトル}
            ...
            \begin{gather*}
                \psi_{pm} = \Psi_{0}\otimes A \pm \Gamma^{34}\Psi \otimes B \\
        ...
        \begin{align*}
            ...
            &=v_{4}(\Gamma^{34}\Psi \otimes B \pm -\Psi_{0}\otimes (-A))\\
            &=\pm v_{4} \psi_{\pm}
        \end{align*}
        故に、同時固有ベクトル$\Psi_{\pm_{1}\pm_{2}}$も、$\psi_{0}$の形を取ると考えられる（ただ、十分条件を示しただけなので、必要条件かはまだ議論をする必要があるが・・・）。\\
        \\
        ...
        \begin{align*}
            ...
            =&\pm_{2}v_{7}(\pm_{1}\Psi_{\pm_{2}}\otimes A + \Psi_{\pm_{2}}\otimes 2)\\
            =&\pm_{1}\pm_{2}\Psi_{\pm_{1}\pm_{2}}
        \end{align*}
        この際、定義より、
        \begin{gather*}
            \Gamma^{3427}\Psi_{\pm_{2}}=\Psi_{\pm_{2}}
        \iff \Gamma^{27}\Psi_{\pm_{2}}=\mp_{2}\Psi_{\pm_{2}}  
        \end{gather*}
        が成立することを用いた。\\
